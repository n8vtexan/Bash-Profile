...
alias localip='ipconfig getifaddr en0'          # localip:      Local LAN IP Address
...
#   -------------------------------------------------------------------
    ii() {
	local PURPLE="\033[35m" #Purple
	local GREEN="\033[32m" #Green
	local NC="\033[m" #Color Reset

        echo -e "\n${PURPLE}You are logged on ${GREEN}" ; hostname
        echo -e "\n${PURPLE}Additionnal information:$GREEN " ; uname -a
        echo -e "\n${PURPLE}Users logged on:$GREEN " ; w -h
